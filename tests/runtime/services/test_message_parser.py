...
from signal_client.runtime.services.worker_pool_manager import Worker, WorkerConfig
...
def test_parse_message_remote_delete(message_parser: MessageParser) -> None:
    """Test parsing a remote delete message."""
    raw_message = {
        "envelope": {
            "source": "+1234567890",
...
def test_parse_message_reaction(message_parser: MessageParser) -> None:
    """Test parsing a reaction message."""
    raw_message = {
        "envelope": {
            "source": "+1234567890",
...
def test_parse_message_attachment(message_parser: MessageParser) -> None:
    """Test parsing a message with an attachment."""
    raw_message = {
        "envelope": {
            "source": "+1234567890",
...
def test_parse_message_mention(message_parser: MessageParser) -> None:
    """Test parsing a message with a mention."""
    raw_message = {
        "envelope": {
            "source": "+1234567890",
