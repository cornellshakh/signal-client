"""Opt-in stress benchmark.

Set RUN_PERFORMANCE_TESTS=1 and run with `pytest -m performance`.
"""
...
async def fast_command(_: Context) -> None:
    """Mock a command that completes quickly."""
    await asyncio.sleep(0)


@command("!slow")
async def slow_command(_: Context) -> None:
    """Mock a command that simulates a long-running operation."""
