...
from signal_client.compatibility import (
    SUPPORTED_MATRIX,
    CompatibilityError,
...
def _reload_metadata(monkeypatch):
    ...
    monkeypatch.setattr("signal_client.compatibility.metadata.version", fake_version)
    monkeypatch.setattr(
        "signal_client.compatibility.metadata.PackageNotFoundError",
