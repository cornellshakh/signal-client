...
from signal_client.adapters.api.profiles_client import ProfilesClient
...
async def test_get_profile_is_unsupported(
    ...
    """Test that getting a profile is unsupported."""
    phone_number = "+1234567890"
...
async def test_get_profile_avatar_is_unsupported(
    ...
    """Test that getting a profile avatar is unsupported."""
    phone_number = "+1234567890"
    with pytest.raises(NotImplementedError):
