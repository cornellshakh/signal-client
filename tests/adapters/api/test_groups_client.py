...
from signal_client.adapters.api.groups_client import GroupsClient
from signal_client.adapters.api.schemas.groups import (
...
async def test_add_admins(
    ...
    """Test adding administrators to a group."""
    phone_number = "+1234567890"
    group_id = "group_id"
