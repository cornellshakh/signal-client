...
class ProfilesClient(BaseClient):
    ...
    async def get_profile(self, phone_number: str) -> dict[str, Any]:
        ...
        Raises:
            NotImplementedError: As direct profile retrieval is not supported by the API.
        """
        msg = (
    ...
    async def update_profile(
        ...
        Args:
            phone_number: The phone number of the account whose profile is being updated.
    ...
    async def get_profile_avatar(self, phone_number: str) -> bytes:
        ...
        Raises:
            NotImplementedError: As direct profile avatar retrieval is not supported by the API.
        """
        msg = (
